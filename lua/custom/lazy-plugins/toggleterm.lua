return {
    {
        ...
        -- Use clean keys{}; no sizing presets. Your global us*/uh* handle sizes.
        keys = (function()
            ...
            return {
                { "<leader>tt", function() vim.cmd("ToggleTerm direction=float") end,      desc = "Terminal (float)",      mode = "n", silent = true, noremap = true },
                { "<leader>th", function() vim.cmd("ToggleTerm direction=horizontal") end, desc = "Terminal (horizontal)", mode = "n", silent = true, noremap = true },
                { "<leader>tv", function() vim.cmd("ToggleTerm direction=vertical") end,   desc = "Terminal (vertical)",   mode = "n", silent = true, noremap = true },
                { "<leader>tg", toggle_lazygit,                                            desc = "LazyGit (float)",       mode = "n", silent = true, noremap = true },
            }
        end)(),
